...
- Loading animation while the event log is scanned: a small spinning
  clock face with cycling status captions, crossfading into the
  resolved timestamp once the scan completes.
